...
///* Functions -----------------------------------------------------------------*/
NoteOnList::NoteOnList(listIndex_t maxLengthIn, uint16_t dataSizeIn) : LinkedList(maxLengthIn, dataSizeIn)
{
...
void NoteOnList::pushModLen( listItem_t * objectToPush, uint16_t lenInClocks )
{
...
void NoteOnList::printList(void)
{
...
void NoteOnList::decrementTimes(uint16_t pulseDelta)
{
...
*/
bool NoteOnList::dropExpiredNote(seqNote_t * pNote)
{
