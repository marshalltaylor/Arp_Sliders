...
public:
    ...
    int32_t ticks;
    int32_t savedTickForDelta;
    
    //Call this repeatedly in your high priority context.
    //This will call the clock's callbacks when necessary
